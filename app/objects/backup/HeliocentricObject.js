...
function findOffset(element) { 
  ...
  return pos;
	...
	function HeliocentricObject(name, mass, semimajor, semiminor, radius, inclination, argPeriapsis, longAscNode, invisible) {
	...
	HeliocentricObject.prototype.create = function(scene, interfaceControls) {
		/* stage objects */
		this.scene			= scene;
		...
		this.GM 			= interfaceControls.toScale(132712440018); // gravitational constant of the Sun
		this.radius			= interfaceControls.planetScale(this.radius);
		this.semimajor		= interfaceControls.toScale(this.semimajor);
		this.semiminor		= interfaceControls.toScale(this.semiminor);
		...
		*/
		...
		this.scene.getScene().add(this.plane);
	...
	HeliocentricObject.prototype.hide = function(hide) {
	...
	HeliocentricObject.prototype.getVectorPosition2 = function() {
		/* assumes matrix world has been updated */
		var vect = new THREE.Vector3();
		vect.setFromMatrixPosition(this.mesh.matrixWorld);
	...
	HeliocentricObject.prototype.addSatellite = function(satellite) {
		/* add a satellite object to its orbit */
		this.pivot.add(satellite);
	};
